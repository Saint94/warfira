                ...
                <div class="col-lg-12">
                    <div class="common_bannner_text">
                        ...
                        <ul>
                            ...
                            <li><span><i class="fas fa-circle"></i></span> Vols</li>
                        </ul>
                    </div>
                </div>
            </div>
                                                                                ...
                                                                                <div class="cabin-selection">
                                                                                    ...
                                                                                    <div class="cabin-list">
                                                                                        ...
                                                                                        <button type="button"
                                                                                            class="label-select-btn">
                                                                                            <span
                                                                                                class="MuiButton-label">First Class</span>
                                                                                        </button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="multi_city_form">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                                                        <div class="form_search_date">
                                                                            <div
                                                                                class="flight_Search_boxed date_flex_area" style="background-color: #EEEFFC">
                                                                                <div class="Journey_date">
                                                                                    <p>Journey date</p>
                                                                                    <input type="date"
                                                                                        value="2022-05-05">
